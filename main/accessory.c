...
homekit_accessory_t *accessories[] = {
                      ...
                      .services=(homekit_service_t*[])
    {
        HOMEKIT_SERVICE(ACCESSORY_INFORMATION, .characteristics=(homekit_characteristic_t*[]){
            HOMEKIT_CHARACTERISTIC(NAME, CONFIG_ESP_HOMEKIT_DEVICE_ACCESSORY_NAME),
            ...
            HOMEKIT_CHARACTERISTIC(MODEL, CONFIG_ESP_HOMEKIT_DEVICE_MODEL_NAME),
        ...
        HOMEKIT_SERVICE(DOORBELL, .characteristics=(homekit_characteristic_t*[]){
            HOMEKIT_CHARACTERISTIC(NAME, CONFIG_ESP_HOMEKIT_DEVICE_SERVICE_NAME_DOORBELL),
        ...
        HOMEKIT_SERVICE(MICROPHONE, .characteristics=(homekit_characteristic_t*[]){
            HOMEKIT_CHARACTERISTIC(NAME, CONFIG_ESP_HOMEKIT_DEVICE_SERVICE_NAME_MICROPHONE),
        ...
        HOMEKIT_SERVICE(SPEAKER, .characteristics=(homekit_characteristic_t*[]){
            HOMEKIT_CHARACTERISTIC(NAME, CONFIG_ESP_HOMEKIT_DEVICE_SERVICE_NAME_SPEAKER),
            HOMEKIT_CHARACTERISTIC(VOLUME, 0),
            HOMEKIT_CHARACTERISTIC(MUTE, true),
            NULL
        }),
...
homekit_server_config_t config = {
    ...
    .setupId=CONFIG_ESP_HOMEKIT_DEVICE_SETUP_ID,
